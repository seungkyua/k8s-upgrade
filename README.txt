...
선택 옵션
  --containerd-upgrade <bool>  containerd.io 도 함께 업그레이드 (기본값: false)
  --containerd-version <ver>   containerd.io 패키지 버전
...
8. (--containerd-upgrade true 인 경우) containerd.io 업그레이드 및 재시작
